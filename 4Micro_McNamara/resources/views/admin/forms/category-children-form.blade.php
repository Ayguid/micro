...
<form method="POST" action="{{route('addCategory')}}">
    ...
    <div class="form-group row">
      ...
      <div class="col-md-6">
          <input id="titulo_es" type="text" class="form-control{{ $errors->has('titulo_es') ? ' is-invalid' : '' }}" name="titulo_es" value="" autofocus>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="desc_es" type="text" class="form-control{{ $errors->has('desc_es') ? ' is-invalid' : '' }}" name="desc_es" value="" autofocus>
