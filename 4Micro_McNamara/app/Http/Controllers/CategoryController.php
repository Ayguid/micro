...
class CategoryController extends Controller
{
  ...
  */
  public function destroy($id)
  {
    ...
    $cAv=Category_Attribute_Value::where('category_id', $cat->id)->get();
    $cAv->each->delete();
  ...
  return DB::transaction(function () use ($request) {
    ...
    $attVal->attribute_id=$att->id;
    $attVal->save();
    $catAttVal = new Category_Attribute_Value();
    $catAttVal->category_id = $request->category_id;
    $catAttVal->attribute_value_id = $attVal->id;
    $catAttVal->save();
    return redirect()->back();
    });
  }
